        ...
        <div class="col-md-8">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form action="/admin/articlecategory/edit" class="form-horizontal" method="post">
                        ...
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="" name="name" value="<?php echo $category->name; ?>">
                            ...
                            <div class="form-group form-md-line-input has-error">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="" name="mark" value="<?php echo $category->mark; ?>">
                                    <div class="form-control-focus"> </div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group form-md-line-input has-warning">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="" name="icon" value="<?php echo $category->icon; ?>">
                                    <div class="form-control-focus"> </div>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="belongsto">
                                        <option value="life" <?php if($category->belongsto == 'life'): ?> selected <?php endif; ?>> Life </option>
                                        <option value="learn" <?php if($category->belongsto == 'learn'): ?> selected <?php endif; ?>> Learn </option>
                                        <option value="like" <?php if($category->belongsto == 'like'): ?> selected <?php endif; ?>> Like </option>
                                    </select>
                                    <div class="form-control-focus"> </div>
                                    <span class="help-block"></span>
                                </div>
                            ...
                            <div class="form-group form-md-radios has-warning">
                                ...
                                <div class="col-md-9">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" id="checkbox1_8" name="status" class="md-radiobtn" value="1" <?php if($category->status == 1): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="md-radio">
                                            <input type="radio" id="checkbox1_9" name="status" class="md-radiobtn" value="0" <?php if($category->status == 0): ?> checked <?php endif; ?>>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <input type="submit" class="btn green" value="更新">
